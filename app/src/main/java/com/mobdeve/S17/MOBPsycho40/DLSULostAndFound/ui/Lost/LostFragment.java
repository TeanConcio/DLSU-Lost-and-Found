...
//        lostViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        ...
        Collections.addAll(lostItemList,
                ...
                new LostItem("04","Mathematics Notebook", Category.STATIONERIES, "A spiral-bound notebook with 'Math 101' written on the cover. Contains detailed notes.", "Laguna", "Found under a desk in the lecture hall", R.drawable.sample_math_notebook, formatter.format(new Date())),
